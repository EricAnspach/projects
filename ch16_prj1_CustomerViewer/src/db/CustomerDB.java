...
public class CustomerDB {
    ...
    public static Customer getCustomer(int number) throws CustomeNotFoundException {
            ...
            switch (number) {
                ...
                case 1004:
                    ...
                    return c;
                default:
                    throw new CustomerNotFoundException("No customer found for the number XXXX.");
            }
    }
}